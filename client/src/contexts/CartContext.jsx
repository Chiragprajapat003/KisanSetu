...
export const CartProvider = ({ children }) => {
    ...
    const validCart = cart.filter(item => item.product && item.product._id);
    const subtotal = validCart.reduce((sum, item) => sum + (item.price || item.product?.price || 0) * item.quantity, 0);
