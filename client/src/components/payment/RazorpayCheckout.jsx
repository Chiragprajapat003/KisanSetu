...
const RazorpayCheckout = ({ orderDetails, onSuccess, onError, user }) => {
    ...
    const handlePayment = async () => {
        ...
        const isMock = orderDetails.razorpayOrderId?.startsWith('order_mock_') ||
                       orderDetails.key === 'your_razorpay_key_id' ||
                       orderDetails.key === 'rzp_test_mock';

        if (isMock) {
            // Simulated Test Payment Flow for Development
            setTimeout(async () => {
                try {
